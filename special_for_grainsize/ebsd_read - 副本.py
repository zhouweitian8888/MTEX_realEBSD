...
folderpath=r"E:\Master\Data\multiPara_EBSD\新建文件夹\9-10"
if folderpath=="":
    ...
    if os.path.exists(name_full[0]+r"/polefig")==True:
        ...
        output=eng.plotebsd_realdata_special_for_grainSize(pname_in,fname_in,pname_out_polefig,pname_out_grainfig,nargout=1)
        print(fname_in)
    else:
